...
- [x] Phase X+2: dashboard publish 파이프 — `scripts/build_dashboard.py` + `scripts/publish_dashboard.sh` → [soccz.github.io/projects/prelude/dashboard](https://soccz.github.io/projects/prelude/dashboard/) (PIN 9963)
- [x] Phase X+2 강화: hedge-fund-grade tear sheet — pyfolio / quantstats / Bailey & Lopez de Prado (2014) 표준 22+ metric (PSR/DSR/MinTRL · IR/Beta/TE · Top 5 DD · Underwater · Monthly heatmap · Best/Worst · Stratification · Score×PnL · References 11개)
